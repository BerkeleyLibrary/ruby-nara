  ...
  def full_display
    ...
    @return = SearchCasefile
      ...
      .select(:LASTNAME, :FIRSTNAME, :MIDDLENAME, :BOXNUMBER,
              ...
              :AFILENUM, :CLASS, :DISPOSITION_OF_CASE, :ST_BORN, :HOUSE_NUM,
              :OTHERNAMEL, :OTHERNAMEF, :OTHERNAMEM,
              :CERTIFICATE_OF_RESIDENCE, :CERTIFICATE_OF_IDENTITY, :RED_EAGLE_CERTIFICATE,
              :COURT_RECORD, :REMARKS, :PORT, :SOURCE, :COMPANY, :DATE_ENTERED)
  end
